...
<header class="main-header">
        <!-- Logo -->
        <a href="<?=Yii::$app->urlManager->createAbsoluteUrl('/site/index');?>" class="logo">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo Html::encode(cuser()->getAvatar()); ?>" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?=Yii::$app->user->identity->username?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<?php echo Html::encode(cuser()->getAvatar()); ?>" class="img-circle" alt="User Image">
                    <p>
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
						<a href="<?=Url::to(["site/logout"])?>" class="btn btn-danger btn-flat">
							Đăng xuất
						</a>
                    </div>
                  </li>
